...
This is still debug-path evidence for the live transport. The screen-to-camera QR proof remains
open for the normal desktop Large Profile QR and Large Home QR path into Android trust and home
join.
