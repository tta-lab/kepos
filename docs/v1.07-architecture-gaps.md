...
- physical QR remains release proof for desktop Large Profile QR and Large Home QR scanning on Android, creating trust and joining the trusted-only home through the normal QR path
...
- the screen-to-camera QR proof remains open for the normal scan path that creates the trust needed before signed home hello and trusted-only home join
...
Pear/Bare variant proves the same path with the desktop worker bridge. The screen-to-camera QR proof
remains open for the normal desktop Large Profile QR and Large Home QR path into Android trust and
home join.
...
Physical QR evidence still needed:

- Desktop Large Profile QR should be scanned by Android and create trust through the normal QR path.
- Desktop Large Home QR should be scanned by Android and join the trusted-only home after trust exists.
