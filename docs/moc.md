...
9. `docs/v1-friend-home-architecture/README.md`
   ...
   Active V1 profile-delivery next plan: `docs/v1-friend-home-architecture/16-v1-profile-delivery-next-plan.md`.
...
1. `docs/v1-friend-home-architecture/16-v1-profile-delivery-next-plan.md`
   - Current next plan: production friend request, accept, and durable DM
     delivery use profile-level P2P only; Home is explicit live-room entry
     after trust.
   - Use this before changing request delivery, accept delivery, DM bootstrap,
     Chat/Profile UX, Home entry, or final V1 proof.

2. `docs/v1-friend-home-architecture/15-v1-ready-product-next-plan.md`
...
3. `docs/v1-friend-home-architecture/14-v1-product-logic-unification-next-plan.md`
...
4. `docs/v1-friend-home-architecture/13-v1-home-decoupling-next-plan.md`
...
5. `docs/v1-friend-home-architecture/12-v1-profile-first-implementation-next-plan.md`
...
6. `docs/v1-friend-home-architecture/11-v1-profile-first-im-next-plan.md`
...
11. `docs/v1.06-identity-security.md`
