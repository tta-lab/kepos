...
9. `docs/v1-friend-home-architecture/README.md`
   ...
   Current V1 ready-product next plan: `docs/v1-friend-home-architecture/15-v1-ready-product-next-plan.md`.
...
1. `docs/v1-friend-home-architecture/15-v1-ready-product-next-plan.md`
   - Current next plan: finish V1 as a profile-first private IM product before
     ...
     the release proof.
   - Use this before continuing implementation or scheduling more phone smoke.

2. `docs/v1-friend-home-architecture/14-v1-product-logic-unification-next-plan.md`
...
3. `docs/v1-friend-home-architecture/13-v1-home-decoupling-next-plan.md`
...
4. `docs/v1-friend-home-architecture/12-v1-profile-first-implementation-next-plan.md`
...
5. `docs/v1-friend-home-architecture/11-v1-profile-first-im-next-plan.md`
...
10. `docs/v1.06-identity-security.md`
