...
1. Extract desktop backend behavior behind a worker-shaped command/event boundary.
   ...
   path from Electron main/preload wiring. Local profile and ContactBook access
   now goes through `src/desktop-profile-context.js`. QR rendering still lives in
