...
- `desktop/package.json`, `desktop/app.tsx`, and `desktop/controller.js` in this repo: verified Electron desktop app with React renderer shell and desktop runtime controller.
