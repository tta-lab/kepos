...
`smoke:two-device:debug:pear` now prove signed DM exchange, restart
persistence, post-restart delivery, and desktop revoke closing the accepted DM
...
and mobile surface pending Direct/People work, guide zero-contact Direct users
toward People, keep raw recipient ids in Advanced, show product empty states
for People, and keep trusted-friend metadata in Home terminology.
