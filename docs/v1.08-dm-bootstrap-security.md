...
`smoke:two-device:debug:pear` now prove signed DM exchange, Chat restart
persistence, post-restart Chat delivery, and desktop revoke closing the accepted Chat
...
and mobile surface pending Chat/Contacts work, guide zero-contact Chat users
