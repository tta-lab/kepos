...
- `docs/v1-friend-home-architecture/22-v1-profile-p2p-delivery-next-plan.md`: active V1 plan; finish production profile-to-profile P2P delivery while keeping Home out of add friend, accept, DM bootstrap, and private Chat.
