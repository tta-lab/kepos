...
- `docs/v1-friend-home-architecture/24-v1-release-proof-next-plan.md`: active V1 plan; finish the final release-proof pass before calling V1 ready or starting V2.
